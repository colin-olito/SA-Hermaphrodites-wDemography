...
\begin{equation}
	\tilde{\mbf{A}}[\tilde{\mbf{n}}] = 
			...
			\underbrace{\left(
			\begin{array}{c|c}
				\mcal{F}^S(\tilde{\mbf{p}}) (1 - \delta) & \mbf{0} \\ \hline
				\mbf{0} & \mcal{F}^X(\tilde{\mbf{p}}) \\
...
\hl{An alternative, based on suggestions from Lotte:}
...
\begin{equation}
	\tilde{\mbf{A}}[\tilde{\mbf{n}}] = 
			...
			\begin{array}{c|c}
				\mcal{F}^S(\tilde{\mbf{p}}) (1 - \delta) & \mbf{0} \\ \hline
				\mbf{0} & \mcal{F}^S(\tilde{\mbf{p}}) (1 - \delta) \\
			\end{array} \right)}_{\tilde{\mbf{F}}_{S}} +
			\underbrace{\left(
			\begin{array}{c|c}
				\mcal{F}^X(\tilde{\mbf{p}}) & \mbf{0} \\ \hline
				\mbf{0} & \mcal{F}^X(\tilde{\mbf{p}}) \\
			\end{array} \right)}_{\tilde{\mbf{F}}_{X}}
\end{equation}
...
\noindent and corresponding matices $\mbb{U}^X$, $\mbb{F}^S$, $\mbb{F}^X$. Because individuals cannot change their genotype once they are born, the survival matrices are block diagonal; $\mcal{U}^S = \mbb{U}^S$ and $\mcal{U}^X = \mbb{U}^X$. We also construct
...
\begin{align*}
	\tilde{\mbf{A}}[\tilde{\mbf{n}}] = 
		& \underbrace{\left(
			...
			&+ \underbrace{\left(
			\begin{array}{ccc|ccc}
				C_{AA} (1 - \delta) \mbf{F}_{AA} & \frac{1}{4} C_{Aa} (1 - \delta) \mbf{F}_{Aa} & 0 & \mbf{0} & \mbf{0} & \mbf{0} \\ 
				0 & \frac{1}{2} C_{Aa} (1 - \delta) \mbf{F}_{Aa} & 0 & \mbf{0} & \mbf{0} & \mbf{0} \\
				0 & \frac{1}{4} C_{Aa} (1 - \delta) \mbf{F}_{Aa} & C_{aa} (1 - \delta) \mbf{F}_{aa} & \mbf{0} & \mbf{0} & \mbf{0} \\ \hline
				q^{\prime}_{A} \mbf{F}_{AA} (1 - C_{AA})& \frac{1}{2} q^{\prime}_{A} \mbf{F}_{Aa} (1 - C_{Aa}) & 0 & \mbf{0} & \mbf{0} & \mbf{0} \\
				q^{\prime}_{a} \mbf{F}_{AA} (1 - C_{AA}) & \frac{1}{2} \mbf{F}_{Aa} (1 - C_{Aa}) & q^{\prime}_{A} \mbf{F}_{aa} (1 - C_{aa}) & \mbf{0} & \mbf{0} & \mbf{0}\\
				0 & \frac{1}{2} q^{\prime}_{a} \mbf{F}_{Aa} (1 - C_{Aa})& q^{\prime}_{a} \mbf{F}_{aa} (1 - C_{aa}) & \mbf{0} & \mbf{0} & \mbf{0}
			\end{array} \right)}_{\tilde{\mbf{F}}} \numberthis
\end{align*}
...
\begin{equation}
	\tilde{\mbf{A}}[\tilde{\mbf{n}}] = 
			...
			\underbrace{\left(
			\begin{array}{c|c}
				\mcal{F}^S(\tilde{\mbf{p}}) C(1 - \delta) & \mbf{0} \\ \hline
				\mbf{0} & \mcal{F}^X(\tilde{\mbf{p}}) \\
			\end{array} \right)}_{\tilde{\mbf{F}}}
\end{equation}
...
Male function:		& $f - s_m$	& $f - h_m s_m$	& $f$ 		\\	
\hline
\end{tabular}
\end{table}
