...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			\item Compare proportion of viable polymorphic parameter space for sexually dimorphic species vs.~close hermaphroditic relative
			\item Possibly {\itshape Silene acaulis} (gynodioecious or dioecious) vs.~hermaphrodite {\itshape Silene} species?
		\end{enumerate}
	\end{enumerate}
