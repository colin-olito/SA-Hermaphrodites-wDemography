...
%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Demographic rate estimates for {\itshape M. guttatus}} \label{sec:MguttMethods}

To illustrate the use of our model with empirical data, and see whether demographic rates observed in natural populations are likely to support balanced SA polymorphisms, we used publicly available demographic and fitness data for natural populations of the hermaphroditic flowering plant {\itshape Mimulus guttatus} ({\itshape Erythranthe guttata}). {\itshape M.~guttatus}
